...
public class CleaningSupervisor extends JFrame implements Observer, ActionListener {
    ...
    /**
     * Declares and sets up GUI elements.
     */
    private void setUpCSPanel() {
        ...
        cleaned = new JButton("Mark as cleaned"); //Button that changes status of MR to cleaned
        ...
        pack(); //Automatically resizes window

    }

    /**
     * Performed when Action event occurs. For Cleaning Supervisor this means when the "Mark as cleaned" button is pressed.
     */
    @Override
    public void actionPerformed(ActionEvent e) {

        if (e.getSource() == cleaned) {
            if (list.getSelectedIndex() == -1) {//Checks if aircraft selected
              ...
              //Changes the Status based on current status. (In line with state diagram)
    ...
    /**
     * Called when change observed in Aircraft Management DB (Updates info in list)
     */
    @Override
    ...
    private void updateManagementRecordList() {
        ...
        /*
         * gets all mCodes where Status relate to cleaning
         */
        ...
        for (int i = 0; i < flightCodes.length; i++) { //For every Cleaning relate dmCode
