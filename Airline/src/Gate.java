...
public class Gate {
     ...
     * Initialises Status to Free
     */
    public Gate() {
        this.status = Gate.FREE;
    }
    ...
    /**
     * @return The corresponding String value of the gates status
     */
