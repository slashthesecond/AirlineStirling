...
public class PassengerList {
    ...
    /**
     * Constructor method for PassengerList
     */
    ...
    /**
     * Removes passenger from details given an index
     * @param index
     */
    ...
    /**
     * returns a boolean base on whether maximum capacity has been reached
     * @return boolean
     */
