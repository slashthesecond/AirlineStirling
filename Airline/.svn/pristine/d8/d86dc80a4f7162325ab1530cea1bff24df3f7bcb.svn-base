...
public class ManagementRecord {
    ...
    /**
     * Gets all details relating to a flight 
     * @return String of all details relating to flight
     */
    ...
    /**
     * Get method for gateNumber 
     * @return int gateNumber
     */
    ...
    /**
     * Gets status Status String for corresponding status code
    ...
    public String getStatusString() {
        ...
        switch (this.status) {
            ...
            case READY_CLEAN_AND_MAINT:
                statusString = "Ready for cleaning and maintenance";
                break;
            case CLEAN_AWAIT_MAINT:
                statusString = "Clean and ready for maintenance";
                break;
    ...
    /**
     * Called when fault has been repaired. Wipes fault.
     */
    public void repair() {
        this.faultDescription = "";
    }
